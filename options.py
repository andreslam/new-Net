...
parser.add_argument("--dataset", type=str, default="rose", choices=["rose", "cria", "drive"],
                    help="dataset")  # choices可扩展
parser.add_argument("--mode", type=str, default="train", choices=["train", "test"], help="train or test")

# data settings
parser.add_argument("--data_dir", type=str, default="G:/OCTA/ROSE/data/ROSE-1/SVC_DVC",
                    help="path to folder for getting dataset")
# parser.add_argument("--data_dir", type=str, default="/home/user3/data/ROSE-1/SVC", help="path to folder for getting dataset")
...
# first stage
parser.add_argument("--first_epochs", type=int, default=50, help="train epochs of first stage")
...
# results
# parser.add_argument("--logs_dir", type=str, default="/home/user3/octa/code/logs", help="path to folder for saving logs")
# parser.add_argument("--models_dir", type=str, default="/home/user3/octa/code/models", help="path to folder for saving models")
# parser.add_argument("--results_dir", type=str, default="/home/user3/octa/code/logs", help="path to folder for saving results")
parser.add_argument("--logs_dir", type=str,
                    default="G:/OCTA/ROSE/OCTA-Net-OCTA-Vessel-Segmentation-Network-master/logs",
                    help="path to folder for saving logs")
parser.add_argument("--models_dir", type=str,
                    default="G:/OCTA/ROSE/OCTA-Net-OCTA-Vessel-Segmentation-Network-master/models2",
                    help="path to folder for saving models")
parser.add_argument("--results_dir", type=str, default="E:/results/", help="path to folder for saving results")
...
parser.add_argument("--first_suffix1", type=str, default="best_thin.pth",
                    help="front_model-[model_suffix].pth will be loaded in models_dir")
parser.add_argument("--second_suffix", type=str, default="best_fusion.pth",
                    help="fusion_model-[model_suffix].pth will be loaded in models_dir")
# parser.add_argument("img", type=str, default="G:/OCTA/ROSE/data/ROSE-1/SVC_DVC/train/img/01.png", help="1")
# parser.add_argument("gt", type=str, default="G:/OCTA/ROSE/data/ROSE-1/SVC_DVC/train/gt/01.tif", help="2")
# parser.add_argument("img_save", type=str, default="E:/new/img/31.png", help="3")
# parser.add_argument("gt_save", type=str, default="E:/new/img/31.tif", help="4")
# 这是原代码，我在frontmain里只跑了50轮
